<template>
  <div class="history">
        <div class="container-grid " id="container">
        <!-- header -->
        <div class="header">
            <a href="#" class="menubtn" onclick=""><img src="../assets/icons/menu.svg" /></a>
            <h3 class="brand-title">History</h3>
        </div>
        <!-- Main Page -->
        <div class="main-page">
            <div class="leftbar" id="sidebar">
                <router-link to="/" class="leftbarbtn"><img src="../assets/icons/fork.svg" /></router-link>
            </div>
            <div class="history">
                <div class="recap">
                    <div class="twinbox twinbox1">
                        <h5>Today's Income</h5>
                        <h3>Rp. 100.000.000</h3>
                        <p>+2% Yesterday</p>
                    </div>
                    <div class="twinbox twinbox2">
                        <h5>Order</h5>
                        <h3>3.270</h3>
                        <p>+5% Last week</p>
                    </div>
                    <div class="twinbox twinbox3">
                        <h5>This Year Income</h5>
...
.header {
  ...
  height: auto;
  grid-template-areas: "menu brand-title";
  background-color: #fff;
...
.main-page {
  display: grid;
  grid-area: main-page;
  grid-template-areas: "leftbar history";
...
.history {
  ...
  .recordertable select#today:required {
    width: 20%;
    height: 50%;
    grid-area: today;
    margin: 20px 20px 0px 0px;
